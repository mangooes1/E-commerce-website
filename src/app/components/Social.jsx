    ...
    <div className="container">
        <div className="row">
            ...
            <div className="col-lg-6 d-flex align-items-center">
                <a href="https://www.instagram.com/stitchndglow?igsh=OTdvY2QxeXY2anJ3" className="btn btn-twitter mb-0 me-2">
                ...
                <a href="https://www.pinterest.com/stitchndglow/" className="btn btn-tumblr mb-0 me-2">
